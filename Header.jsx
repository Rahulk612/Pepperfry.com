                ...
                <div  className="items" style={{marginLeft:"5%"}}>
                    ...
                    "/></Button> */}
                     <div onClick={() => {openForm(); }}>
                         ...
                         <img alt="imgtag" src="https://ii1.pepperfry.com/images/svg/header-profile-icon-2021.svg" style={{cursor:"pointer"}}/></div> 
                  </div>
 ...
 <div className="form-popup" id="myForm">
  <div  className="form-container">
    ...
    <form  style={{marginTop:"50px"}}>
        ...
        <Link to="/login"> <button id='btn2'>  Existing User? Log In  </button> </Link>
