    ...
    return (
        <div className="main">
            ...
            <div className="main-one">
                ...
                <div className="one">
                    <div className="one1">
                        <img className="img1" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Rooms_Section_Web_1__2x_17022022.jpg" alt="" />
                        <p className="one2">Living Room</p>
                    </div>
                    <div className="one1">
                        <img className="img1" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Rooms_Section_Web_2__2x_17022022.jpg" alt="" />
                        <p className="one2">Work From Home</p>
                    </div>
                    <div className="one1">
                        <img className="img1" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Rooms_Section_Web_3__2x_17022022.jpg" alt="" />
                        <p className="one2">Bedroom</p>
                    </div>
                    <div className="one1">
                        <img className="img1" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Rooms_Section_Web_4__2x_17022022.jpg" alt="" />
            ...
            <div className="main-one">
                ...
                <div className="two">
                    <div className="two2">
                        <img className="img21" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Trend_Section_WEB_1_2x_17022022-new.jpg" alt="" />
                    </div>
                    <div className="two2">
                        <img className="img21" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Trend_Section_WEB_2_2x_17022022-new.jpg" alt="" />
                    </div>
                    <div className="two3">
                        <img className="img22" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Trend_Section_WEB_3_2x_17022022.jpg" alt="" />
                        <img className="img22" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Trend_Section_WEB_5_2x_17022022-new.jpg" alt="" />
                        <img className="img22 two-space" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Trend_Section_WEB_4_2x_17022022.jpg" alt="" />
                        <img className="img22 two-space" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Trend_Section_WEB_6_2x_17022022.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div className="main-one">
                ...
                <div className="five">
                    ...
                    <div className="three1">
                        <img className="img5" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Budget_Block_WEB_1_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">4 Seater Dinning Sets less than 40K </h6>
                        <p className="one2 three-img-head-color">85+ Options</p>
                    </div>
                    <div className="three1">
                        <img className="img5" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Budget_Block_WEB_2_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">King Size Beds less than 30K </h6>
                        <p className="one2 three-img-head-color">150+ Options</p>
                    </div>
                    <div className="three1">
                        <img className="img5" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Budget_Block_WEB_3_2x_17022022-new.jpg" alt="" />
                        <h6 className="three-head">Coffee Tables less than 10K </h6>
                        <p className="one2 three-img-head-color">226+ Options</p>
                    </div>
                    <div className="three1">
                        <img className="img5" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Budget_Block_WEB_3_2x_17022022.jpg" alt="" />
            ...
            <div className="change-color">
                <div className="main-two">
                    <div className="three three-space">
                        ...
                        <div className="three1">
                            <img className="img3" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Style_Block_Web_1_2x_17022022.jpg" alt="" />
                            <h6 className="three-head">Modern</h6>
                            <p className="one2 three-img-head-color">Form Meets Function</p>
                        </div>
                        <div className="three1">
                            <img className="img3" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Style_Block_Web_2_2x_17022022.jpg" alt="" />
                            <h6 className="three-head">Traditional</h6>
                            <p className="one2 three-img-head-color">Old World Charm</p>
                        </div>
                        <div className="three1">
                            <img className="img3" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Style_Block_Web_3_2x_17022022.jpg" alt="" />
            ...
            <div className="main-one main-swiper swiper">
                ...
                <div className="two swiper-wrapper">
                    ...
                    <div className="three1 swiper-slide">
                        <img className="img4" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Collection_Block_WEB_1_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">Scandinavian Collection</h6>
                        <p className="one2 three-img-head-color">Modern, Minimal & Chic</p>
                    </div>
                    <div className="three1 swiper-slide">
                        <img className="img4" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Collection_Block_WEB_2_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">Elle Decor Collection</h6>
                        <p className="one2 three-img-head-color">Sofas & More</p>
                    </div>
                    <div className="three1 swiper-slide">
                        <img className="img4" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Collection_Block_WEB_3_2x_17022022.jpg" alt="" />
            ...
            <div className="main-one">
                ...
                <div className="five">
                    ...
                    <div className="three1">
                        <img className="img5" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Decor_Block_WEB_1_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">Hanging Lights</h6>
                        <p className="one2 three-img-head-color">Instant Makeover</p>
                    </div>
                    <div className="three1">
                        <img className="img5" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Decor_Block_WEB_2_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">Metal Wall Art</h6>
                        <p className="one2 three-img-head-color">A Sleek Addition</p>
                    </div>
                    <div className="three1">
                        <img className="img5" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Decor_Block_WEB_3_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">Pots & Planters</h6>
                        <p className="one2 three-img-head-color">Green Is In</p>
                    </div>
                    <div className="three1">
                        <img className="img5" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Decor_Block_WEB_4_2x_17022022.jpg" alt="" />
                        <h6 className="three-head">Wall Shelves</h6>
                        <p className="one2 three-img-head-color">Flying Off The Shelves</p>
                    </div>
                </div>
            </div>
            <div className="main-one">
                ...
                <div className="six">
                    ...
                    <div className="three1">
                        <img className="img6" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Brands_WEB_1__2x_17022022.jpg" alt="" />
                    </div>
                    <div className="three1">
                        <img className="img6" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Brands_WEB_2__2x_17022022.jpg" alt="" />
                    </div>
                    <div className="three1">
                        <img className="img6" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Brands_WEB_3__2x_17022022.jpg" alt="" />
                    </div>
                    <div className="three1">
                        <img className="img6" src="https://ii2.pepperfry.com/media/wysiwyg/banners/Homepage_Brands_WEB_3__2x_17022022-1.jpg" alt="" />
                    </div>
                    <div className="three1">
                        <img className="img6" src="https://ii3.pepperfry.com/media/wysiwyg/banners/Homepage_Brands_WEB_5__2x_17022022.jpg" alt="" />
                    </div>
                    <div className="three1">
                        <img className="img6" src="https://ii1.pepperfry.com/media/wysiwyg/banners/Homepage_Brands_WEB_6__2x_17022022.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div className="main-one">
                <div className="seven">
                    ...
                    <div className="seven1">
                        <img className="img7" src="https://ii2.pepperfry.com/media/wysiwyg/banners/mat-20-jan-1-n-1.jpg" alt="" />
                    </div>
                    <div className="seven1">
                        <img className="img7" src="https://ii3.pepperfry.com/media/wysiwyg/banners/mod-20-jan-1-n-1.jpg" alt="" />
                    </div>
                </div>
            </div>
